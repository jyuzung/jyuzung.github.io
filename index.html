...
<div class="row">
  <div class="leftcolumn" style="width:60%; padding:10px 40px 10px 10px; font-size: x-large;">
    <div class="card">
      ...
      <ul>
        <li style="margin:0.5em 0;">登录页面: <a href="file:///D:/workHTML/wangYeBuJu/login.html">file:///D:/workHTML/wangYeBuJu/login.html</a></li>
        <li style="margin:0.5em 0;">注册页面: <a href="file:///D:/workHTML/wangYeBuJu/sign.html">file:///D:/workHTML/wangYeBuJu/sign.html</a></li>
        <li style="margin:0.5em 0;">js数据验证: <a href="file:///D:/workHTML/wangYeBuJu/db.html?kd=root">file:///D:/workHTML/wangYeBuJu/db.html?kd=root</a></li>
